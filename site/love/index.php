<?php  
	...
	$location="../";
	// $location="../../htdocs/"; 
	$location="../../promition.org/htdocs/"; 
	$location_composer="../../htdocs/"; 
	...
	require_once($location."parser.php");	
	require_once($location_composer."vendor/autoload.php");	
...
<div id="divbody" style="max-width:1000px;  position: absolute;    top:0;    bottom: 0;    left: 0;    right: 0;   margin: auto; overflow:hidden;" >
	<div id="div_top" style="display:none; opacity:50%; max-width: 1000px;  position: fixed;  margin:   auto; left: 0; right: 0; top:0px; z-index:2;  width: 100%; height:50px; font-size: 10px; background-color:gray;   flex-direction: row;   flex-wrap: nowrap;   justify-content: space-between "> 
		<div id="bt_logout" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;  " onclick="bt_logoutf()">
			<img src="images/4115235-exit-logout-sign-out_114030.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>		
		<div id="btnAdd" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;  " >
			<img src="images/install-software-download.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>
		<div id="divnear" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;  " onclick="menuf(0)">
			<img src="images/location_106422.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>		
		<div id="divpm" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;     " onclick="menuf(1)">
			<img src="images/falar.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>	
		<div id="divdonate" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;     " onclick="menuf(2)">
			<img src="images/donate-48_44778.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>
		<div id="divperfil" style="text-align: center; margin:auto;  box-sizing: border-box; cursor: pointer; border-radius: 4px;  max-width: 35px; max-height: 35px;     " onclick="menuf(3)">
			<img src="images/4213460-account-avatar-head-person-profile-user_115386.png" style="height: auto; width: auto; max-width: 35px; max-height: 35px;" ></img>
		</div>  
	</div>
<div id="div_entrada" style=" max-width: 800px; position:absolute; top:52px;    "> 
	...
	Funcionamos à boa fé das pessoas pelo que aceitamos doações de pessoas que ficam satisfeitas com o serviço e também ganhamos quando o utilizador clica em publicidade neste site, porque esta é uma ferramenta para ver um futuro com pessoas que não só estejam submissas à corrupção do dinheiro que manipula os serviços da internet.
...
<div id="div_body" style="display:none; max-width: 1000px; width:100%; height:100%; position:absolute; top:52px;   flex-direction: row;  ">
	...
	<div id="div_perfil" > 
		...
		<div id="perfil_2" style="display:none;">
			...
			<img id="imgsrc" src="<?php echo $just_domain.'/pic/'.$id.'.jpg?'.$res[0]['datem'].rand();?>" style="width: auto; max-height: 80px; max-width: 80px; " onclick="document.getElementById('image').click();">
			</form>
			</div>
	...
	<div id="div_donate" >
		<br>
		<div id="div_don_funds" class="w3-card-4" style="text-align: center; margin: auto; max-width:600px;">
			Enjoy our meeting love service for free, but if you can, please donate as the donations <b>go all for people in need</b> as stated at www.promition.org, we are a service of Promition.<br><br><br>
			<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
			<input type="hidden" name="cmd" value="_xclick-subscriptions">
			<input type="hidden" name="business" value="superbem@gmail.com">
			<input type="hidden" name="lc" value="PT">
			<input type="hidden" name="item_name" value="Mission Save">
		...
		<?php 
		echo parsegooglehttp("https://docs.google.com/document/d/e/2PACX-1vTRiTXko4fa4qVN9TMIIzsf9hw7NJ21JXGwKpFsdrprYw1Y_ZrqGDFQqVo1icCjVkBIDY7SjXFlZXBI/pub",array(
...
function menuf(idx){
	...
	for(var i=0;i<div_slider.length;i++)
		div_slider_buttons[i].style.backgroundColor="transparent";
	div_slider_buttons[idx].style.backgroundColor="pink";
} 
menuf(3); 
window.onload=function(){menuf(2);div_loader.style.display="none";}
