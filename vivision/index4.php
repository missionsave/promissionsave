...
window.onresize = function(){adjust();};
  ...
  // fnBrowserDetect();
		...
		<button id="buttonCarregar" class="buttonpp" style="max-width:110px; float:right; margin-top:0px;  display:none; color:#000; " onclick='if( /Android|iPhone|iPad|iPod/i.test(navigator.userAgent) ) {window.location="intent:googlechrome://navigate?url=promissionsave.com?i=1#Intent;end";	}else btcarregarf();'><?php echo d('buy')?></button>
