...
<title>Euromillions.site <?php echo @$stitle; ?></title>
...
<body  onresize="onresizeFunction(0)">	
	
<div class="topheader" id="topheaderid">
<div class="topnav" id="myTopnav">
	<a href="	<?php echo  $indexp.'?pg=home'.'&l='.$lg;	?>" class="active">Euromillions.site</a>
  

	<a href="	<?php echo  $indexp.'?pg='.$_GET['pg'].'&l='.($lg==1?'0':'1') ;	?>  "><?php echo "Achar numeros";?></a> 
	<a href="	<?php echo  $indexp.'?pg='.$_GET['pg'].'&l='.($lg==1?'0':'1') ;	?>  "><?php echo "Achar estrelas";?></a> 
	<a href="	<?php echo  $indexp.'?pg='.$_GET['pg'].'&l='.($lg==1?'0':'1') ;	?>  "><?php echo "Chaves completas";?></a> 
...
function onresizeFunction(func){ 
	...
	var tottop=clientHeight;//+document.getElementById('nexttotop').clientHeight;
	if(func)func(tottop);
}
   	onresizeFunction(); 
</script>
